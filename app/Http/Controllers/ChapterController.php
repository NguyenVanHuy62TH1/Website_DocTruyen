...
class ChapterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            'slug_chapter.unique' => 'Slug chương đã có, vui lòng điền slug khác.',
            'tieude.unique' => 'Tên chương đã có, vui lòng điền tên khác.',
            'tieude.required' => 'Hãy điền tên chương.',
            'tomtat.required' =>   'Hãy điền tóm tắt.',
            'noidung.required' =>   'Hãy điền nội dung.',
            'slug_chapter.required' =>   'Hãy điền slug của chương.',
